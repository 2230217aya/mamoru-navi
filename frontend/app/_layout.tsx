...
import HomeScreen from '../app/(tabs)/index'; // app/(tabs)/index.tsx を指す
import MyPageScreen from '../app/(tabs)/my-page'; // app/my-page.tsx を指す
import OfflineDataScreen from '../app/(tabs)/offline-data'; // app/offline-data.tsx を指す
import DashboardScreen from '../app/dash-bord'; // app/dashboard.tsx を指す
